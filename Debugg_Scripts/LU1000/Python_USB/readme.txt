Python_USB MATLAB Python Package
...
Verify that a Windows version of Python 2.7, 3.7, and/or 3.8 is installed.

2. Installing the Python_USB Package

A. Change to the directory that contains the file setup.py and the subdirectory 
Python_USB. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the Python_USB Package

The Python_USB package is on your Python path. To import it into a Python script or 
session, execute:
