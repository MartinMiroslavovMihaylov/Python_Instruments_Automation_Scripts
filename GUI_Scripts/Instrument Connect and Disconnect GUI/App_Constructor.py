...
class App(customtkinter.CTk):
    ...
    def ConnectInst(self):
        ...
        for elements in self.InstrumentSelected:    
            if elements == " Anrtisu Spectrum Analyzer MS2760A ":
                print(elements)
                ...
                Ist_List.append(SA)
                # return SA
            elif elements == " Anritsu Signal Generator MG3694C ":
                print(elements)
                ...
                Ist_List.append(SG)
                # return SG
            elif elements == " Anritsu Vectro Analyzer MS4647B ":
                print(elements)
                ...
                Ist_List.append(VNA)
                # return VNA
            elif elements == ' Power Meter ThorLabs PM100D ':
                print(elements)
                ...
                Ist_List.append(PM)
                # return PM
            elif elements == " Novoptel Laser LU1000 ":
                print(elements)
                ...
                Ist_List.append(LU)
                # return LU
            elif elements == " Yokogawa Optical Spectrum Analyzer AQ6370D ":
                print(elements)
                ...
                Ist_List.append(OSA)
                # return OSA
            elif elements == " KEITHLEY Source Meter 2612 ":
                print(elements)
                ...
                Ist_List.append(KA)
                # return KA
            elif elements == " Power Supply KA3005 ":
                print(elements)
                ...
                Ist_List.append(PS)
                # return PS
            elif elements == " CoBrite Tunable Laser ":
                print(elements)
                ...
                Ist_List.append(CO)
                # return CO
            elif elements == " AnaPico AG,APPH20G ":
                print(elements)
                APP = InstInit(elements)
                self.Instrument.append(APP)
                print('AnaPico AG,APPH20G is connected as PS')
                Ist_List.append(APP)
                # return APP
            elif elements == " 4-Channels Power Suppy GPP4323 ":
                print(elements)
                GPP = InstInit(elements)
                self.Instrument.append(GPP)
...
class DissconnectApp(customtkinter.CTk):
